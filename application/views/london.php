        ...
        <div class="container-lg">
            <div class="row">
                <div class="col-md-12 positoin-relative">
                    ...
                    <img src="<?php echo base_url(); ?>assets/images/public/street/london-icon.svg" alt="" class="get-src d-table mx-auto wow fadeInDown animated" data-wow-duration="1s" data-wow-delay="0.5S">
            ...
            <div class="row px-md-5 px-3 mt-md-0 mt-5">
                <div class="col-md-4">
                    ...
                    <img src="<?php echo base_url(); ?>assets/images/public/street/london-icon.svg" alt="" class="get-src d-table mx-auto wow fadeInDown animated" data-wow-duration="1s" data-wow-delay="1S">
                    ...
                    <a href="javascript:void(0)" class="exploer-btn" data-type="eat">EXPLORE <img src="<?php echo BASE_URL(); ?>assets/images/public/home/ex-arow.svg" alt="" class="ml-4"></a>
                </div>
                <div class="col-md-4">
                    ...
                    <a href="javascript:void(0)" class="exploer-btn" data-type="style">EXPLORE <img src="<?php echo BASE_URL(); ?>assets/images/public/home/ex-arow.svg" alt="" class="ml-4"></a>
        ...
        <div class="container-lg">
            ...
            <div class="row mt-4 d-lg-flex d-none justify-content-center" id="photos">
                <div class="col-xxl-9" id="photo-gallery">
                    <div class="owl-carousel slider-desk wow fadeInUp animated" data-wow-delay="300mss">
                        <div class="item">
                            <div class="row">
                                <div class="col-md-4 ">
