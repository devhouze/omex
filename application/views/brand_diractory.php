<div class="brand-directory-page barnd-page">
    ...
    <div class="brand-directory gray-bg pt-60 pb-30">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-10 positoin-relative">
                    <h5 class="fz40 fz24-sm pr-font h-color d-table mx-auto text-center mb-0 px-lg-5 mt-60 pt-60">Brand Directory</h5>
                </div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-10">
                    <ul class="me-0 mt-40 p-0 d-flex justify-content-center">
