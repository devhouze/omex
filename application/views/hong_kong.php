<div class="hongkong-page">
    ...
    <div class="live-in-word gray-bg pt-30 position-relative">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 positoin-relative">
                    <h5 class="fz40 fz24-sm pr-font h-color d-table mx-auto text-center mb-0">Welcome to the dreamland, a place like no other!</h5>
                    <img src="<?php echo BASE_URL(); ?>assets/images/public/street/hong-icon.svg"  alt="" class="d-table mx-auto">
                    <div class="v-line d-table mx-auto"></div>
                </div>
            </div>
    ...
    <div class="hello-area looking-out gray-bg py-30 position-relative">
        <div class="container">
            <div class="row">
                <div class="col-md-12 positoin-relative">
                    <h5 class="fz40 fz24-sm pr-font h-color d-table mx-auto text-center mb-0">Hello from Hong Kong!</h5>
                    <img src="<?php echo BASE_URL(); ?>assets/images/public/street/hong-icon.svg"  alt="" class="d-table mx-auto">
                    <div class="v-line d-table mx-auto"></div>
                </div>
            </div>
