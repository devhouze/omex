<div class="hongkong-page">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 positoin-relative">
                    <h5 class="fz40 fz24-sm pr-font h-color d-table mx-auto text-center mb-0 px-lg-5">Wander into the heart of Asia's world city- Hong Kong</h5>
    ...
    <div class="live-in-word gray-bg pt-30 position-relative">
        ...
        <img src="<?php echo BASE_URL(); ?>assets/images/public/street/hong.svg"  alt="" class="d-table mx-auto">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-md-12 positoin-relative">
                    <h5 class="fz40 fz24-sm pr-font h-color d-table mx-auto text-center mb-0 wow fadeInDown animated" data-wow-duration="1s" data-wow-delay="1s">Welcome to the dreamland, a place like no other!</h5>
                    <img src="<?php echo BASE_URL(); ?>assets/images/public/street/hong-icon.svg"  alt="" class="d-table mx-auto">
                    <div class="v-line d-table mx-auto wow zoomIn animated" data-wow-duration="1s" data-wow-delay="1.8s"></div>
                </div>
            </div>
                ...
                <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="d-flex position-absolute">
                        <a class="carousel-control-prev" href="#carouselExampleControls" role="button" data-bs-slide="prev">
                            <img src="<?php echo BASE_URL(); ?>assets/images/public/street/hong-left.svg" alt="" class="w-100">
                        </a>
    ...
    <div class="hello-area looking-out gray-bg py-30 position-relative">
        <div class="container">
            <div class="row">
                <div class="col-md-12 positoin-relative">
                    <h5 class="fz40 fz24-sm pr-font h-color d-table mx-auto text-center mb-0 wow fadeInDown animated" data-wow-duration="1s" data-wow-delay="1s">Hello from Hong Kong!</h5>
                    <img src="<?php echo BASE_URL(); ?>assets/images/public/street/hong-icon.svg"  alt="" class="d-table mx-auto">
                    <div class="v-line d-table mx-auto wow zoomIn animated" data-wow-duration="1s" data-wow-delay="1.8s"></div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row mt-4 d-flex flex-fill">
                ...
                <div class="col-md-4 d-flex flex-fill">
                    <div class="card hon-bg px-40 py-40 rounded-0 border-0">
                        <img src="<?php echo BASE_URL(); ?>assets/images/public/home/h-s.svg" alt="">
