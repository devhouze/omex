<div class="portugal-page">
    ...
    <div class="live-in-word gray-bg pt-30 position-relative">
        ...
        <div class="container-lg">
            <div class="row">
                <div class="col-md-12 positoin-relative">
                    <h5 class="fz40 fz24-sm pr-font h-color d-table mx-auto text-center mb-0 wow fadeInDown animated">The oldest and most colorful city of Europe<sapn class="d-lg-block"> awaits your presence!</span></h5>
    ...
    <div class="hello-area looking-out gray-bg py-30 position-relative">
        <div class="container-lg">
            <div class="row">
                <div class="col-md-12 positoin-relative">
                    <h5 class="fz40 fz24-sm pr-font h-color d-table mx-auto text-center mb-0 wow fadeInDown animated">Hello from Portugal Street!</h5>
                    <img src="<?php echo BASE_URL(); ?>assets/images/public/street/portugal-icon.svg" alt="" class="d-table mx-auto">
                    <div class="v-line d-table mx-auto wow zoomIn animated" data-wow-duration="1s" data-wow-delay="1s"></div>
                </div>
            </div>
