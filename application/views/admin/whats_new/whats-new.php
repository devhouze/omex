            ...
            <div class="col-lg-12">
                <div class="card card-default">
                    <div class="card-header card-header-border-bottom">
                        <a href="<?=admin_url('add-whats-new')?>" class="btn btn-primary">Add</a>
                    </div>
                    <div class="card-body">
                        <table class="table table-hover ">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        <label class="switch">
                                          <input type="checkbox" class="chkstatus" value="<?php echo $wn['id'];?>" <?php echo ($wn['status']=="0")?'checked':'' ?>>
                                    ...
                                    <td>
                                        ...
                                        <a href="javascript:void(0)" class="btn btn-danger delete" data-id="<?=$wn['id'];?>"><span class="mdi mdi-delete"></span></a>
                                        <a href="javascript:void(0)" data-toggle="modal" data-target="#whatsNew" class="btn btn-primary view_whats_new" title="View Details" data-id="<?=$wn['id'];?>"><span class="mdi mdi-eye"></span></a>
                                    </td>
                                    <?php } ?>
                                </tr>
                                <?php } } else {?>
...
<div class="modal fade" id="whatsNew" tabindex="-1" role="dialog" aria-labelledby="whats_newLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="whats_newLabel">What's New Details</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <span class="whats_new"></span>
      </div>
