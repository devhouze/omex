      <div class="content-wrapper">
        <div class="content">
          ...
          <div class="row">
            ...
            <?php //print_r($this->session->userdata('admin_details')); ?>
            <div class="col-xl-3 col-sm-6">
              <div class="card card-mini mb-4">
                <div class="card-body">
                    ...
                    <tbody>
                        ...
                        <td>
                          <div class="media">
                            <div class="media-image mr-3 rounded-circle">
                              <!-- <a href="profile.html"><img class="rounded-circle w-45" src="assets/images/admin/u1.jpg" alt="customer image"></a> -->
                            </div>
                      ...
                      <tr>
                        <td>
                          <div class="media">
                            <div class="media-image mr-3 rounded-circle">
                              <!-- <a href="profile.html"><img class="rounded-circle w-45" src="assets/images/admin/u2.jpg" alt="customer image"></a> -->
                            </div>
                            <div class="media-body align-self-center">
                              <a href="profile.html">
                      ...
                      <tr>
                        <td>
                          <div class="media">
                            <div class="media-image mr-3 rounded-circle">
                              <!-- <a href="profile.html"><img class="rounded-circle w-45" src="assets/images/admin/u3.jpg" alt="customer image"></a> -->
                            </div>
                            <div class="media-body align-self-center">
                              <a href="profile.html">
                      ...
                      <tr>
                        <td>
                          <div class="media">
                            <div class="media-image mr-3 rounded-circle">
                              <!-- <a href="profile.html"><img class="rounded-circle w-45" src="assets/images/admin/u4.jpg" alt="customer image"></a> -->
                            </div>
                            <div class="media-body align-self-center">
                              <a href="profile.html">
                      ...
                      <tr>
                        <td>
                          <div class="media">
                            <div class="media-image mr-3 rounded-circle">
                              <!-- <a href="profile.html"><img class="rounded-circle w-45" src="assets/images/admin/u5.jpg" alt="customer image"></a> -->
                            </div>
                            <div class="media-body align-self-center">
                              <a href="profile.html">
                ...
                <div class="card-body py-0">
                  <div class="media d-flex mb-5">
                    <div class="media-image align-self-center mr-3 rounded">
                      <a href="#"><img src="<?php echo BASE_URL(); ?>assets/images/admin/p1.jpg" alt="customer image"></a>
                    </div>
                    <div class="media-body align-self-center">
                      <a href="#">
                  ...
                  <div class="media d-flex mb-5">
                    <div class="media-image align-self-center mr-3 rounded">
                      <a href="#"><img src="<?php echo BASE_URL(); ?>assets/images/admin/p2.jpg" alt="customer image"></a>
                    </div>
                    <div class="media-body align-self-center">
                      <a href="#">
                        <h6 class="mb-3 text-dark font-weight-medium"> Coach Swagger</h6>
                  ...
                  <div class="media d-flex mb-5">
                    <div class="media-image align-self-center mr-3 rounded">
                      <a href="#"><img src="<?php echo BASE_URL(); ?>assets/images/admin/p3.jpg" alt="customer image"></a>
                    </div>
                    <div class="media-body align-self-center">
                      <a href="#">
