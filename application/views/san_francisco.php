<div class="san-page">
    ...
    <div class="live-in-word gray-bg pt-30 position-relative">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 positoin-relative">
                    <h5 class="fz40 fz24-sm pr-font h-color d-table mx-auto text-center mb-0">The city with the Golden Gate welcomes you <span class="d-lg-block"> with warm arms.</span></h5>
                    <img src="<?php echo BASE_URL(); ?>assets/images/public/street/san-icon.svg" alt="" class="d-table mx-auto">
                    <div class="v-line d-table mx-auto"></div>
                </div>
            </div>
    ...
    <div class="hello-area looking-out gray-bg py-30 position-relative">
        <div class="container">
            <div class="row">
                <div class="col-md-12 positoin-relative">
                    <h5 class="fz40 fz24-sm pr-font h-color d-table mx-auto text-center mb-0">Hello from San Francisco!</h5>
                    <img src="<?php echo BASE_URL(); ?>assets/images/public/street/san-icon.svg" alt="" class="d-table mx-auto">
                    <div class="v-line d-table mx-auto"></div>
                </div>
            </div>
