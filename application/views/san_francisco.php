<div class="san-page">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 positoin-relative">
                    <h5 class="fz40 fz24-sm pr-font h-color d-table mx-auto text-center mb-0 px-lg-5">Welcome to a home to a bit of everything, San Francisco. </h5>
    ...
    <div class="live-in-word gray-bg pt-30 position-relative">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 positoin-relative">
                    <h5 class="fz40 fz24-sm pr-font h-color d-table mx-auto text-center mb-0 wow fadeInDown animated" data-wow-duration="1s" data-wow-delay="1s">The city with the Golden Gate welcomes you <span class="d-lg-block"> with warm arms.</span></h5>
                    <img src="<?php echo BASE_URL(); ?>assets/images/public/street/san-icon.svg" alt="" class="d-table mx-auto">
                    <div class="v-line d-table mx-auto wow zoomIn animated" data-wow-duration="1s" data-wow-delay="1.8s"></div>
                </div>
            </div>
    ...
    <div class="hello-area looking-out gray-bg py-30 position-relative">
        <div class="container">
            <div class="row">
                <div class="col-md-12 positoin-relative">
                    <h5 class="fz40 fz24-sm pr-font h-color d-table mx-auto text-center mb-0 wow fadeInDown animated" data-wow-duration="1s" data-wow-delay="1s">Hello from San Francisco!</h5>
                    <img src="<?php echo BASE_URL(); ?>assets/images/public/street/san-icon.svg" alt="" class="d-table mx-auto">
                    <div class="v-line d-table mx-auto wow zoomIn animated" data-wow-duration="1s" data-wow-delay="1.8s"></div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row mt-4 d-flex flex-fill">
                ...
                <div class="col-md-4 d-flex flex-fill">
                    <div class="card san-bg px-40 py-40 rounded-0 border-0">
                        <img src="<?php echo BASE_URL(); ?>assets/images/public/home/s-s.svg" alt="">
